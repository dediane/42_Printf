...
/*   Updated: 2021/04/10 13:04:23 by ddecourt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_display_prec_width_u(long unsigned int nb,
long unsigned int size, t_flags flags)
{
	if (flags.minus == 1)
	{
...
void				ft_display_prec_u(long unsigned int nb,
long unsigned int size, t_flags flags)
{
	if ((flags.num_before == 0) && (flags.num_after == 0))
		ft_putnbr_u(nb);
